use crate::{errors::{interpreter_error::InterpreterError, lang_error::IResult}, interpreter::{Interpreter, value::Value}, lexer::token::{Token, TokenKind}, parser::expression::Expr};
...
impl Interpreter {
  ...
  pub(crate) fn eval_compound_assign(&mut self, expr: &Expr, name: &String, value: &Box<Expr>, op: &Token) -> IResult<Value> {
